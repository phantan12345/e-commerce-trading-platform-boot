                                        ...
                                        <h4>Leave your experience</h4>
                                            <form action="" onSubmit={submitHandler}>
                                                ...
                                                <div className="form__group d-flex align-items-center gap-5">
                                                    ...
                                                    <span onClick={()=>setRating(1)}>2 <i class="ri-star-s-fill"></i></span>
                                                    <span onClick={()=>setRating(1)}>3 <i class="ri-star-s-fill"></i></span>
                                                    <span onClick={()=>setRating(1)}>4 <i class="ri-star-s-fill"></i></span>
                                                    <span onClick={()=>setRating(1)}>5 <i class="ri-star-s-fill"></i></span>
                                                </div>
