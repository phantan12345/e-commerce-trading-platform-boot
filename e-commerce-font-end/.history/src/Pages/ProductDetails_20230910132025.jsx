         ...
         <Col lg="6">
           <div className="product__details">
             ...
             <div className="d-flex align-items-center gap-5 mb-3">
               ...
               <span>Category: {product.categoriesCategoryId.categoryName.toUpperCase()}</span>
             </div>
         ...
         <Col lg="12">
           ...
           {tab === "desc" ? (
             <div className="tab__content mt-5">
               <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi ab illum, hic nam alias at sit cumque animi sint eum eveniet, sed nobis quae ad soluta. Sequi non animi alias!</p>
             </div>
           ) : (
