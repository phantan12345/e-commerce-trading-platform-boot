...
function AddProduct() {
  ...
  function showWidget() {
    const widget = window.cloudinary.createUploadWidget(
      {
        cloudName: "your-cloud-name", // Thay thế bằng tên cloud của bạn
        uploadPreset: "your-upload-preset", // Thay thế bằng upload preset của bạn
      },
      (error, result) => {
        if (!error && result.event === "success") {
          setSelectedImage(result.info.secure_url); // Lưu URL của hình ảnh đã chọn
        }
      }
    );
    widget.open();
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div>
                <FormGroup className="form__group">
                  ...
                  <button
                    className="buy__btn"
                    type="button" // Đây là nút để gọi widget Cloudinary
                    onClick={showWidget}
                  >
                    Add Image
                  </button>
