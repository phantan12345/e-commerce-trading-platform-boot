            ...
            <div className='nav__wrapper'>
                ...
                <div className='nav__icons'>
                    ...
                    <div className='profile'>
                        ...
                        src={currentUser? currentUser.photoURLuserIcon} alt='' onClick={toggleProfileAction} />
                        
                        <div className="profile__actions" ref={profileActionRef} onClick={toggleProfileAction}>
                        {
                            currentUser ?
                            <div className='d-flex align-items-center justify-content-center flex-column'>
                                <span><i class="ri-logout-box-r-line"></i> Logout</span>
                                
                                 <Link to='/signup'><i class="ri-user-line"></i> Profile</Link> 
                            </div>:
                            <div className='d-flex align-items-center justify-content-center flex-column'>
