...
const ProductsList = ({data, pageSize,shouldShowPagination }) => {
    ...
    return (
        ...
        <Pagination className='d-flex align-items-center' responsive={true} pageSize={PAGE_SIZE} total={totalItems} current={currentPage} onChange={(p,_)=>handlePageChange(p)}/>
