                                        ...
                                        <h4>Leave your experience</h4>
                                            <form action="" onSubmit={submitHandler}>
                                                ...
                                                <div className="form__group d-flex align-items-center gap-5">
                                                    <mospan onClick={()=>setRating(1)}>1 <i class="ri-star-s-fill"></i></mospan>
                                                    <mospan onClick={()=>setRating(2)}>2 <i class="ri-star-s-fill"></i></mospan>
                                                    <mospan onClick={()=>setRating(3)}>3 <i class="ri-star-s-fill"></i></mospan>
                                                    <mospan onClick={()=>setRating(4)}>4 <i class="ri-star-s-fill"></i></mospan>
                                                    <mospan onClick={()=>setRating(5)}>5 <i class="ri-star-s-fill"></i></mospan>
                                                </div>
