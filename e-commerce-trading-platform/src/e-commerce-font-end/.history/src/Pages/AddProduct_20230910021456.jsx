...
import { productCreateRequest, productCreateSuccess, productCreateFail } from "../redux/slices/product"; // Thay thế "yourProductSliceFile" bằng đường dẫn đến tệp slice của sản phẩm của bạn.
...
function AddProduct() {
  ...
  function handleSubmit(e) {
    ...
    // Dispatch action để bắt đầu quá trình tạo sản phẩm
    dispatch(productCreateRequest());

    // Gọi API để tạo sản phẩm
    axios
      .post("/api/createProduct", { name, description, price, category, images })
      .then((response) => {
          ...
          <Col lg="12">
            ...
            <Form onSubmit={handleSubmit}>
              <FormGroup className="form__group">
                ...
                <input type="text" placeholder="Double sofa" value={name} onChange={(e) => setName(e.target.value)} />
              </FormGroup>
              <FormGroup className="form__group">
                <span>Short Description</span>
                <input type="text" placeholder="lorem..." value={description} onChange={(e) => setDescription(e.target.value)} />
              </FormGroup>
              <FormGroup className="form__group">
