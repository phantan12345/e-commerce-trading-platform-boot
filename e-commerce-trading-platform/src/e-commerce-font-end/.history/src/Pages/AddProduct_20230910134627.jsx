...
import { productCreateFail, productCreateRequest, productCreateSuccess } from "../redux/slices/product"; // Thay thế "yourProductSliceFile" bằng đường dẫn đến tệp slice của sản phẩm của bạn.
...
function AddProduct() {
  ...
  function handleSubmit(e) {
    ...
    axios
      .post("/api/product", { productName: name, price, categories:category, images })
      .then((response) => {
