        ...
        <section>
            <Container>
                <Row>
                    ...
                    <Col lg='3'>
                        <div>
                            <h6 className='d-flex align-items-center justify-content-be'>Subtotal</h6>
                            <span>${totalAmount}</span>
                        </div>
                        <p>taxes and shipping will calculate in checkout</p>
                        <div>
                            <button className="buy__btn"><Link to='/shop'/>Continue Shopping</button>
                            <button className="buy__btn"><Link to='/checkout'/>Checkout</button>
                        </div>
                    </Col>
                </Row>
            </Container>
